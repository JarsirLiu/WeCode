...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "WeCode 会话分享" : "WeCode Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "WeCode - Web + Server";
