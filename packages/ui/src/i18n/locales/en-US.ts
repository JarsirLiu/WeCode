...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like WeCode to show its work?",
  ...
  "startup.global.silent": "Starting WeCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen WeCode.",
  ...
  "startup.global.starting_services": "Starting WeCode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "WeCode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another WeCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen WeCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen WeCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen WeCode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a WeCode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into WeCode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to WeCode and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to WeCode bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "WeCode saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "WeCode uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to WeCode.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to WeCode's `/api/bots/webhook` endpoint.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another WeCode window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to WeCode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to WeCode",
  "login.description": "Connect your account to start using WeCode",
  ...
  "logout.confirm.title": "Disconnect and restart WeCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only WeCode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About WeCode",
  ...
  "forceUpdate.title": "Update WeCode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart WeCode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the WeCode CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control WeCode workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "WeCode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the WeCode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While WeCode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the WeCode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching WeCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by WeCode",
  ...
  "resourceManager.storage.diskUsage": "WeCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the WeCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "WeCode could not verify its Windows secure import component. Reinstall or update WeCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, WeCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by WeCode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "WeCode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This WeCode Agent cannot refresh OAuth status. Upgrade or restart WeCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to WeCode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into WeCode",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to WeCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by WeCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in WeCode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. WeCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in WeCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "WeCode MCP",
  ...
  "sidebar.usage.plan.mcp": "WeCode MCP",
  "sidebar.usage.plan.zcodeMcp": "WeCode MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for WeCode built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into WeCode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. WeCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into WeCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by WeCode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend WeCode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into WeCode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. WeCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into WeCode",
  ...
  "settings.commands.description":
    "Manage WeCode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "WeCode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into WeCode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. WeCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into WeCode",
  ...
  "settingsSync.action.finish": "Start using WeCode",
  "settingsSync.agent.zcode": "WeCode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current WeCode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to WeCode",
  ...
  "onboarding.welcome.title": "Welcome to WeCode",
  "onboarding.welcome.start": "Start WeCode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while WeCode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "WeCode will copy {source} to {target}.\nIf the target file already exists, the WeCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask WeCode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask WeCode anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, WeCode will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want WeCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart WeCode app and retry, or ask WeCode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with WeCode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for WeCode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with WeCode in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current WeCode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'WeCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No WeCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "WeCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "WeCode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while WeCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task WeCode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "WeCode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "WeCode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart WeCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart WeCode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified WeCode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "WeCode will verify the Computer Use tools against the exact session when your first session starts.",
